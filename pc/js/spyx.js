            ...
            $.each(arwr, function(i, item) {
                ...
                var lihtml = $(
                    `<div class="swiper-slide">
                        <video class="video" id="video${i+1}" preload="auto" src="${item.src}"  data-id="${i+1}" page-gesture="true" 
...
<h1>如果视频出现侵权,可与第三方进行协谈</h1>
     <div id="tm">
      ...
      <img src="./img/tm3.png" width="80" style="transform:translate(0px,-504px);opacity:0.3">
					</div>
     </div>
            ...
            $("#wrap").on("click", ".swiper-slide .play", function(e) {
                ...
                if (video.paused) {
                    ...
                    $(this).children("img").hide();
                     document.getElementById("tm").innerHTML='<div class="functions"><img src="./img/tm2.png" width="80" style="transform:translate(0px,-504px);opacity:0.2"></div>';
                } else {
                    video.pause();
                    $(this).children("img").show();
                     document.getElementById("tm").innerHTML='<div class="functions"><img src="./img/tm3.png" width="80" style="transform:translate(0px,-504px);opacity:0.2"></div>';
                }
